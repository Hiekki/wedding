...
export default function RegistryClient() {
    ...
    return (
        <section className='relative min-h-[calc(100vh-6rem)] lg:min-h-[calc(100vh-9rem)] w-full overflow-hidden'>
            ...
            <div className='relative z-10 w-full max-w-5xl mx-auto px-6 py-14 text-sage'>
                <div className='mx-auto max-w-2xl rounded-3xl bg-cream/70 px-8 py-10 text-sage shadow-lg backdrop-blur-sm lg:max-w-5xl lg:px-14 lg:py-12'>
                    <div className='text-center'>
                        ...
                        <p className='text-sage/70 text-md lg:text-lg tracking-wide max-w-lg lg:max-w-3xl mx-auto font-open'>
                            Your presence is the greatest gift we could ask for. If you would like to bless us with something extra, we’ve
                            set up a honeymoon fund and a traditional registry.
                        </p>
                    ...
                    <div>
                        <div className='flex flex-col items-center text-center'>
                            <p className='mt-3 text-sage/70 font-open max-w-lg lg:max-w-3xl'>
                                We’ve carefully selected a few items to help us start this next chapter together. If you’d like to bless us
                                with a gift, you can find our registries below.
                            </p>
                        </div>
                    ...
                    <div className='mt-8 lg:max-w-3xl mx-auto rounded-2xl border border-rose/20 bg-cream/70 backdrop-blur-sm shadow-sm px-6 lg:px-8 py-8'>
                        <div className='flex flex-col items-center text-center'>
                            ...
                            <p className='mt-3 text-sage/80 font-open max-w-xl text-sm lg:text-md'>
                                If you’d like to contribute to our honeymoon, you can send a gift through Cash App. Please include your name
                                in the note so we can thank you properly.
                            </p>
                    ...
                    <div className='mt-14 text-center pb-12 lg:pb-0'>
                        ...
                        <p className='text-sage/60 font-open text-sm'>
                            Thank you for celebrating with us — we truly can’t wait to see you!
                        </p>
                    </div>
                </div>
            </div>
